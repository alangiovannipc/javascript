$ mkdir -p eslint // Create the folder aslant to implement aslant $ cd eslint //Move to the eslint folder $ npm init -y //Create a default package.json file without asks any questions.
